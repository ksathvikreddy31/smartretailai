...
#         # Delete old products for retailer_id = 4
#         deleted = db.query(RetailerProduct).filter(
#             RetailerProduct.retailer_id == 4
#         ).delete()

#         print(f"🗑️ Deleted {deleted} old products from retailer_id=4")
...
#         print("✅ Products inserted successfully for retailer_id=4")
